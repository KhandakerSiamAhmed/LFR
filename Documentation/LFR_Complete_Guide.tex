...
All calibration and configuration are structurally managed through the OLED display and rotary encoder.
\begin{enumerate}
    \item \textbf{Run Mode}: 
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Calibrate Mode}: Triggers Min/Max boundary sweep logic for array sensors.
    ...
    \end{itemize}
    \item \textbf{EEPROM Storage}: All constants and calibration arrays auto-save to EEPROM.
\end{enumerate}
